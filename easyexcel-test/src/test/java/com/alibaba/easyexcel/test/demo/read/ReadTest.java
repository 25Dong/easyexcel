...
import com.alibaba.excel.read.listener.MaxRowReadListener;
...
public class ReadTest {
	...
	public void testMaxRow() {
		...
		EasyExcel.read(fileName, DemoData.class, new MaxRowReadListener<DemoData>(2, integerReadCellDataMap -> {
					System.out.println("读到了标题");
		}, demoData -> {
...
//        String fileName = TestFileUtil.getPath() + "demo" + File.separator + "demo.xlsx";
		...
		PageReadListener<ConfigGoods> configGoodsPageReadListener = new PageReadListener<ConfigGoods>(new Consumer<List<ConfigGoods>>() {
			@Override
			public void accept(List<ConfigGoods> configGoods) {

			}
		}) {
			@Override
			public void invoke(ConfigGoods data, AnalysisContext context) {
				ReadRowHolder readRowHolder = context.readRowHolder();
				Integer rowIndex = readRowHolder.getRowIndex();
				System.out.println("现在是读取第：" + rowIndex);
				super.invoke(data, context);
			}
		};
		EasyExcel.read(fileName, ConfigGoods.class, configGoodsPageReadListener)
